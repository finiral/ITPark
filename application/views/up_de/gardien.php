            ...
            <div class="row element-2 opt-2 my-2 pb-2">
                                ...
                                <div class="col-10 col-lg-6">
                                    <div class="row text-wrap">
                                        <div class="icon-text-inline">
                                            ...
                                            <span class="lieu">gard-00<?php echo $user['id_utilisateur'] ?></span>
                                        </div>
                                    </div>
                                    <div class="row text-wrap">
                                        <div class="icon-text-inline">
                                            <i class="bi-car-front-fill"></i>
                                            <span class="lieu">park-00<?php echo $user['id_parking'] ?></span>
                                        </div>
                                    </div>
                                    <div class="row text-wrap">
                                        <div class="icon-text-inline">
                                            <i class="bi bi-calendar-check-fill"></i>
                                            <span class="lieu"><?php echo $user['date_mouvementgardien'] ?></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-2">
                    <div class="row"><a class="btn btn-warning"
                            href="<?php echo site_url("Mouvement_gardien/indexe/".$user['id_utilisateur']) ?>">
                            <span class="d-none d-lg-block">Attribuer</span>
